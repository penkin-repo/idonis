...
- Избегай общих слов ("сделай зарядку", "пей воду"). Пиши только так: "22:00 — 20 отжиманий", "22:15 — 0.5л воды".
- Если речь о еде — называй конкретные виды (не "суп", а "куриный суп").
- Если речь о покупках — пиши конкретные граммы, кг, пакеты или штуки.
- **В вечернее время всегда рекомендуй конкретное время сна** (ориентируйся на цель 23:00 из контекста), чтобы обеспечить 8 часов отдыха.
